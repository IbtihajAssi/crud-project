...
//   } 
  return (
    ...
    <div className="row flex-nowrap">
      ...
      {/* <Input id={'username'} title={'User Name'} type={'text'} name={'name'} onChange={changeData} />
      <Input id={'useremail'} title={'User Email'} type={'email'} name={'email'} onChange={changeData} />
      <Input id={'userpassword'} title={'User Password'} type={'password'} name={'password'} onChange={changeData} />
   */}
  <div className="mb-3">
    <label htmlFor="username" className="form-label">User Name</label>
    <input type="text" name="name" className="form-control" id="username"  value={user.name} onChange={()=>changeData(event)}/>
  </div>
  {errors.name &&  <p className='text-danger'>{errors.name }</p>}
  <div className="mb-3">
    <label htmlFor="useremail" className="form-label">User Email</label>
    <input type="email" name="email" className="form-control" id="useremail" value={user.email}  onChange={()=>changeData(event)}/>
  </div>
  {errors.email &&  <p className='text-danger'>{errors.email }</p>}
  <div className="mb-3">
    <label htmlFor="userpassword" className="form-label">User Password</label>
    <input type="password" name="password" className="form-control" id="userpassword" value={user.password}   onChange={()=>changeData(event)}/>
  </div>
  {errors.password &&  <p className='text-danger'>{errors.password }</p>}
  <div className="mb-3">
    <input type="submit" className="form-control bg-light" value='Edit user' />
  </div>
</form>
