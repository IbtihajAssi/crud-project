...
<Loader />
  ...
  <div className="mb-3">
    ...
    <input type="text" name="name" className="form-control" id="username"  onChange={()=>changeData(event)}/>
  </div>
  {errors.name &&  <p className='text-danger'>{errors.name }</p>}
  <div className="mb-3">
    <label htmlFor="useremail" className="form-label">User Email</label>
    <input type="email" name="email" className="form-control" id="useremail"  onChange={()=>changeData(event)}/>
  </div>
  {errors.email &&  <p className='text-danger'>{errors.email }</p>}
  <div className="mb-3">
    <label htmlFor="userpassword" className="form-label">User Password</label>
    <input type="password" name="password" className="form-control" id="userpassword"   onChange={()=>changeData(event)}/>
  </div>
  {errors.password &&  <p className='text-danger'>{errors.password }</p>}
  <div className="mb-3">
    <input type="submit" className="form-control bg-light" value='Add user' />
  </div>
</form>
